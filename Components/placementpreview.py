...
class PlacementPreview():
    ...
    def create_translucent_obj(self, obj_type, block_selected, colour=False, display_range=False):
        ...
        if self.display_range:
            ...
            # self.range_surface.fill((255, 255, 255, 75))
    ...
    def draw(self):
        ...
        if self.display_range:
            ...
            pygame.draw.circle(self.range_surface, (255, 255,
                               255, 75), self.range_surface.get_rect().center, self.range_surface.get_width()/2)
